...
from model_europe_air import ReGMM_VGAE
from preprocessing import load_data, sparse_to_tuple, preprocess_graph, load_data_networks
...
nClusters = 4
adj, features , labels = load_data_networks('europe', './data/Airports/')
